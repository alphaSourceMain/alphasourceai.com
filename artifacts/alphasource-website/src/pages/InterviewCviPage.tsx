...
// Retained only for deterministic regression coverage of the previously
// deployed Daily publication-confirmation helper. The live local-closing path
// no longer calls or waits on this protocol.
